...
async def create_welcome(member):
    ...
    for frame in ImageSequence.Iterator(bg_gif):
        ...
        try:
            font_small = ImageFont.truetype(FONT_PATH, 20)  # حجم الخط أصغر
        ...
        # النص أسفل الصورة مباشرة، أقصى اليسار
        text_x = avatar_x
        text_y = avatar_y + avatar_image.size[1] + 5  # 5px أسفل الصورة

        # تأثير نيون أسود حول النص
...
bot.run("MTQxMjI1NTgzMTc3MjM2NDk5Mg.GXxHHc.1kWbjEVFVgO2x9H_n6HmVhF1aez-xTxKxq1nxQ")
